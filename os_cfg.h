...
#define OS_TASK_NAME_SIZE         2 // 16    /*     Determine the size of a task name                        */
...
#define OS_MEM_NAME_SIZE          2    /*     Determine the size of a memory partition name            */
...
#define OS_TMR_CFG_NAME_SIZE      2    /*     Determine the size of a timer name                       */
